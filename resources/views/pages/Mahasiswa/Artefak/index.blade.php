                                ...
                                <div class="col-12">
                                    @foreach ($artefak as $item)
                                        <ul class="nav nav-tabs mb-4" style="border-bottom: 1px solid #ddd;">
                                            <li class="nav-item">
                                                <a class="nav-link {{--  --}}"
                                                    href="{{ route('artefak.index') }}">
                                                    PENGUMPULAN BERKAS
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link {{--  --}}"
                                                    href="{{ route('status_perizinan') }}">
                                                    STATUS PERIZINAN MAJU SEMINAR
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link {{--  --}}"
                                                    href="{{ route('jadwal.seminar') }}">
                                                    JADWAL SEMINAR
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link {{--  --}}"
                                                    href="{{ route('feedback.show', Crypt::encrypt($item->id)) }}">
                                                    FEEDBACK
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link {{--  --}}"
                                                    href="{{ route('revisi.index') }}">
                                                    BERKAS FINAL
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="card mb-4 shadow-sm border">
                                                    <div class="card-body">
                                                        <h5 class="card-title font-weight-bold">{{ $item->Judul_Tugas }}
                                                        </h5>
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                ...
                                                                <span
                                                                    class="text-danger">{{ $item->formatted_deadline }}</span>
                                                            </li>
                                                        </ul>
                                                        <div class="mb-2">
                                                            <span
                                                                class="badge badge-{{ $status ? 'success' : 'secondary' }}">
                                                                {{ $status ? $status->status : 'Belum dikumpulkan' }}
                                                            </span>
                                                            <a href="{{ route('artefak.create', Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        <div class="text">
                                                            <a href="{{ route('PengajuanSeminar.create') }}">
                                                                <button type="submit" class="btn btn-warning">
                                                                    <i class="fas fa-paper-plane mr-1"></i> Ajukan Maju
                                                                    Seminar
                                                                </button>
                                                            </a>
                                                        </div>
                                                    @else
                                                        @foreach ($pengajuanSeminars as $item)
                                                            @if ($item->status == 'menunggu')
                                                                ...
                                                                <form method="POST"
                                                                    action="{{ route('PengajuanSeminar.destroy', Crypt::encrypt($item->id)) }}"
                                                                    style="display: inline;">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
                                                                        class="btn btn-sm btn-danger show_confirm"> Batalkan
                                                                        Pengajuan
