...
@section('title', 'Nilai Individu Penguji 2')
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>List Nilai Individu Penguji 2 (35%)</h4>
                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-center align-items-center"
                                                            ...
                                                            <div class="d-flex" style="gap: 8px;">
                                                                <button
                                                                    ...
                                                                    <i class="fas {{ $nilai ? 'fa-edit' : 'fa-plus' }}"></i>
                                                                </button>

                                                                @if ($nilai)
                                                                    <form
                                                                        action="{{ route('penguji2.NilaiIndividu.destroy', $nilai->id) }}"
                                                        ...
                                                        <div class="collapse" id="nilai{{ $mhs->user_id }}">
                                                            ...
                                                            <div class="card m-3 shadow-sm">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <form
                                                                        action="{{ $nilai ? route('penguji2.NilaiIndividu.update', $nilai->id) : route('penguji2.NilaiIndividu.store') }}"
                                                                        method="POST">
