...
@section('title', 'Nilai Kelompok Penguji 1')
<style>
    .toggle-collapse,
    .show_confirm {
        min-width: 115px;
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    ...
                                                    <div class="d-flex justify-content-center align-items-center"
                                                        ...
                                                        @if ($nilai)
                                                            <form
                                                                action="{{ route('penguji1.NilaiKelompok.destroy', $nilai->id) }}"
                                                    ...
                                                    <div class="collapse" id="nilaiKelompok{{ $item->id }}">
                                                        ...
                                                        <div class="card m-3 shadow-sm">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <form method="POST"
                                                                    action="{{ $nilai ? route('penguji1.NilaiKelompok.update', $nilai->id) : route('penguji1.NilaiKelompok.store') }}">
