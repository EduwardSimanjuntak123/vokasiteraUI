...
@section('title', 'Nilai Kelompok Penguji 2')
<style>
    .toggle-collapse,
    .show_confirm {
        min-width: 115px;
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header d-flex justify-content-between">
                            <h4>List Nilai Kelompok Penguji 2 (35%)</h4>
                        </div>
                                        ...
                                        @foreach ($kelompok as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    ...
                                                    <div class="d-flex justify-content-center align-items-center"
                                                        ...
                                                        @if ($nilai)
                                                            <form
                                                                action="{{ route('penguji2.NilaiKelompok.destroy', $nilai->id) }}"
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4" class="p-0 border-0">
                                                    ...
                                                    <div class="collapse" id="nilaiKelompok{{ $item->id }}">
                                                        ...
                                                        <div class="card m-3 shadow-sm">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <form method="POST"
                                                                    action="{{ $nilai ? route('penguji2.NilaiKelompok.update', $nilai->id) : route('penguji2.NilaiKelompok.store') }}">
