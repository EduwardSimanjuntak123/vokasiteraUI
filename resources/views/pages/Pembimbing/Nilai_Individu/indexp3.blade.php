                                                        ...
                                                        <div class="collapse" id="nilai{{ $mhs->user_id }}">
                                                            ...
                                                            <div class="card m-3 shadow-sm">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <form
                                                                        action="{{ $nilai ? route('pembimbing1.NilaiBimbingan.update', $nilai->id) : route('pembimbing1.NilaiBimbingan.store') }}"
                                                                        method="POST">
                                                                        ...
                                                                        @foreach ($komponenNilai as [$name, $label])
