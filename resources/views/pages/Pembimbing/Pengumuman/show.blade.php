                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <p><strong><i class="fas fa-calendar-alt mr-1"></i> Tanggal:</strong>
                                        {{ $pengumuman->created_at->format('d-m-Y') }}</p>
                                    <p><strong>Pengirim:</strong>{{ $pengumuman->nama }}</p>
                                </div>
                                <div class="col-md-6">
                                    <p><strong><i class="fas fa-info-circle mr-1"></i> Status:</strong>
                                        <span
                                            class="badge badge-{{ $pengumuman->status === 'aktif' ? 'success' : 'secondary' }}">
                        ...
                        @endif --}}
                            @if ($pengumuman->file)
                                <div class="text-center mt-5">
                                    <a href="{{ asset('storage/' . $pengumuman->file) }}" class="btn btn-primary btn-sm"
                                        target="_blank">
