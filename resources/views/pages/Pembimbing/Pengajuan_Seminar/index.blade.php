                                                    ...
                                                    @if ($pengajuan->files->count() > 0)
                                                        <div class="dropdown">
                                                            <button class="btn btn-sm btn-info dropdown-toggle"
                                                                type="button" id="fileDropdown{{ $pengajuan->id }}"
                                                                data-toggle="dropdown" aria-haspopup="true"
                                                                aria-expanded="false">
                                                                {{ $pengajuan->files->count() }} File
                                                            </button>
                                                            <div class="dropdown-menu"
                                                                aria-labelledby="fileDropdown{{ $pengajuan->id }}">
                                                                @foreach ($pengajuan->files as $file)
                                                                    <a class="dropdown-item"
                                                                        ...
                                                                        <i
                                                                            class="
                                                                    @if (in_array(strtolower(pathinfo($file->file_name, PATHINFO_EXTENSION)), ['jpg', 'jpeg', 'png', 'gif'])) fas fa-image
                                                ...
                                                <td>
                                                    @if ($pengajuan->catatan)
                                                        <button type="button" class="btn btn-sm btn-info"
                                                            data-toggle="modal"
                                                            data-target="#catatanModal{{ $pengajuan->id }}">
                                                            Lihat Catatan
                                                        </button>

                                                        <!-- Modal untuk melihat catatan -->
                                                        <div class="modal fade" id="catatanModal{{ $pengajuan->id }}"
                                                    ...
                                                    @if ($pengajuan->status == 'menunggu')
                                                        <div class="d-flex" style="gap: 8px;">
                                                            <button type="button" class="btn btn-sm btn-success"
                                                                data-toggle="modal"
                                                                data-target="#setujuiModal{{ $pengajuan->id }}"
                                                                title="Setujui" data-toggle="tooltip" data-placement="top">
                                                                <i class="fas fa-check"></i>
                                                            </button>
                                                            <button type="button" class="btn btn-sm btn-danger"
                                                                data-toggle="modal"
                                                                data-target="#tolakModal{{ $pengajuan->id }}"
                                                        ...
                                                        <!-- Modal Setujui -->
                                                        <div class="modal fade" id="setujuiModal{{ $pengajuan->id }}"
                                                            tabindex="-1" role="dialog" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                        ...
                                                        <!-- Modal Tolak -->
                                                        <div class="modal fade" id="tolakModal{{ $pengajuan->id }}"
                                                            tabindex="-1" role="dialog" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
