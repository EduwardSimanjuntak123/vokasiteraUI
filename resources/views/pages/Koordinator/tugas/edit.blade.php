            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('tugas.update', ['id' => Crypt::encrypt($tugas->id)]) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="Deskripsi_Tugas" id="Deskripsi_Tugas" rows="5"
                                        class="form-control fs-5 @error('Deskripsi_Tugas') is-invalid @enderror" style="height: 200px;"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="tanggal_pengumpulan" id="tanggal_pengumpulan"
                                        ...
                                        value="{{ old('Judul_Tugas', $tugas->tanggal_pengumpulan) }}">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="border rounded p-1 bg-light d-inline-block">
                                            ...
                                            @if (in_array(strtolower($fileExt), ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'webp']))
                                                <img src="{{ $filePath }}" alt="Dokumen Lama"
                                                    style="max-width: 100px; max-height: 100px; border-radius: 10px;">
                                            @else
                                                <a href="{{ $filePath }}"
                                                    target="_blank">📄{{ basename($tugas->file) }}</a>
                                            @endif
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option value="Berlangsung"
                                            {{ old('status', $tugas->status) == 'Berlangsung' ? 'selected' : '' }}>
                                            Berlangsung</option>
                                        <option value="Selesai"
                                            {{ old('status', $tugas->status) == 'Selesai' ? 'selected' : '' }}>Selesai
                                        </option>
                                    </select>
                                </div>
