                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('kelompokMahasiswa.create', ['id' => $kelompok->id]) }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex" style="gap: 8px">
                                                        <a href="{{ route('kelompokMahasiswa.edit', Crypt::encrypt($item->id)) }}"
                                                            class="btn btn-success btn-sm" data-toggle="tooltip"
                                                            data-placement="top" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form method="POST"
                                                            action="{{ route('kelompokMahasiswa.destroy', $item->id) }}">
                                                            @csrf
                                                            @method('delete')
